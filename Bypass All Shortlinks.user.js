...
// @include /^(https?:\/\/)(sitr|downfile|savelink|linkshortify|shareus|promo-visits|mobileprice|mynurse|short1|forextrader)(\.site)(\/.*)/
...
// @include /^(https?:\/\/)(adrev|paid4|yousm|coinpayz|tr|yocto|clk.dti|besturl|boostme|takefile|appo|pureshort|linkshortifyx|panyshort|mdiskshortner)(\.link)(\/.*)/
...
// @include /^(https?:\/\/)(exey|ezlinks|techmody|ouo|ex-e|saly|cuty|evoload|oke|letsupload|eio|oii|exe|viplinks)(\.io)(\/.*)/
...
(function() {
    ...
    BloggerPemula('linksfire.co|shareus.site|mdiskshortner.link', 'url,api', '', false);
