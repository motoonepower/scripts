...
// @include /^(https?:\/\/)(ctbl|girls-like|gobits|zoss|shrinke|tlin|terafly|petafly|gigafly|adnews|papanews|panyflay|mozzfly|shortus|short.croclix|best-news|mega-news|wildblog|specx|dddrive|linkpoi|m.newhit|mboost|linkshorts|exafly|nonofly|lozzfly|uptomega|stfly|adbull|youshort|health-and|cutx|adsk|linkfly|shorter.earn-hub|pkin|cashando|hunterkiller|acortalink)(\.me)(\/.*)/
// @include /^(https?:\/\/)(.+)?(theconomy|richlink)(\.me)(\/.*)/
// @include /^(https?:\/\/)(newforex|wplink|nbyts|wealthystyle|clicksfly|happy-living|webcoin.coinrain|teacherana|earnow|earn-cash|yourtechnology|apks|network-earn|battleroyal|forexit)(\.online)(\/.*)/
...
// @match   *://cryptorotator.website/newsletter/*
...
(function() {
    ...
    BypassedByBloggerPemula(/link.medipost.org/, {'/': [RexBp, 'https://blog.medipost.org/'],}, false);
    ...
    BypassedByBloggerPemula(/1short.io/, function() {if (elementExists('#form-redirect')) {setTimeout(function() {bp('#countDownForm').submit();}, 3000);}});
    ...
    BypassedByBloggerPemula(/healdad.com|gamalk-sehetk.com|newforex.online|forex-gold.net|world-trips.net|mobi2c.com|forexit.online/, function() {clickIfElementExists('.submitBtn', 2);});
    ...
    BypassedByBloggerPemula(/mobi2c.com|newforex.online|world-trips.net|forex-gold.net|healdad.com|gamalk-sehetk.com|mobitaak.com|forexit.online/, function() {clickIfElementExists('#go_d', 3, 'setInterval');});
