...
// @include /^(https?:\/\/)(scratch247|siyn|portablesusb|children-learningreading|azmath|mobilereview|inform3tion|mobilism|shortlinkto|uptobhai|bitcrypto|machicon-akihabara|cooklike|videoclip|brbushare|fanclup|nulledlist)(\.info)(\/.*)/
// @include /^(https?:\/\/)(aylink|linkszia|mynewsmedia|gtlink|droplink|123link|linksfy|adshorti|hxfile|dosya|veganal|takem|ezimg|eng.ezimg|dausel|modlink|9-animie|veganho|nulledmod|veganac|dealprice|arabplus2|cut-y|adshort)(\.co)(\/.*)/
...
(function() {
    ...
    BypassedByBloggerPemula(/kalvidudes.in|techwithsanikant.in|nulledlist.info/, () => waitForElm('div#getlinkbtn center a', kalv => redirect(kalv.href, false)));
