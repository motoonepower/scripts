...
(function() {
    ...
    function EnableRCF() {[].forEach.call(['contextmenu', 'visibilitychange', 'copy', 'cut', 'paste', 'blur', 'mouseleave', 'mouseup', 'mousedown', 'keyup', 'keydown', 'drag', 'dragstart', 'hasFocus', 'focus', 'select', 'selectstart', 'webkitvisibilitychange', 'mozvisibilitychange'],function(event) {document.addEventListener(event, function(e) { e.stopPropagation(); }, true);});}
