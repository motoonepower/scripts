...
// @include /^(https?:\/\/)(adrev|paid4|yousm|coinpayz|tr|yocto|clk.dti|besturl|boostme|takefile|appo|pureshort|linkshortifyx|panyshort|mdiskshortner|leit|shortano|shortino)(\.link)(\/.*)/
...
(function() {
    ...
    BypassedByBloggerPemula(/on-scroll.com|diudemy.com/, function() {waitForElm("form.text-center a", roll => redirect(roll.href, false));if (elementExists('#brand')) {setTimeout(function() {redirect(bp('#brand').value, false);}, 2000);}});
