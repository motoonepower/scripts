...
// @include /^(https?:\/\/)(.+)?(takez|linksfire|vosan|tinygo|veganab|adfloz|fexkomin)(\.co)(\/.*)/
// @include /^(https?:\/\/)(ctbl|girls-like|gobits|zoss|shrinke|tlin|terafly|petafly|gigafly|adnews|papanews|panyflay|mozzfly|shortus|short.croclix|best-news|mega-news|wildblog|specx|dddrive|linkpoi|m.newhit|mboost|linkshorts|exafly|nonofly|lozzfly|uptomega|stfly|adbull|youshort|health-and|cutx|adsk|linkfly|shorter.earn-hub|pkin|cashando)(\.me)(\/.*)/
// @include /^(https?:\/\/)(.+)?(theconomy|richlink)(\.me)(\/.*)/
// @include /^(https?:\/\/)(sitr|downfile|savelink|linkshortify|shareus|promo-visits|mobileprice|mynurse)(\.site)(\/.*)/
// @include /^(https?:\/\/)(.+)?(cekip|link4rev|coin-city|urlcash)(\.site)(\/.*)/
...
// @include /^(https?:\/\/)(adrev|paid4|yousm|coinpayz|tr|yocto|clk.dti|besturl|boostme|takefile|appo|pureshort|linkshortifyx)(\.link)(\/.*)/
...
// @include /^(https?:\/\/)(bloogerspoot|linkshor|cortlink)(\.tk)(\/.*)/
// @include /^(https?:\/\/)(.+)?(madfaucet|mineshor|futureshor)(\.tk)(\/.*)/
// @include /^(https?:\/\/)(bloogerspoot|urlchanger|arearn|360shortlink)(\.ml)(\/.*)/
// @include /^(https?:\/\/)(onimports|link.encurtaon|economiarelevante)(\.com\.br)(\/.*)/
// @include /^(https?:\/\/)(exee|onlineteori|punyablog|activity|massive|caview|nesiaku)(\.my\.id)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?(adslinkfly|readi|linkmumet)(\.online)(\/.*)/
// @include /^(https?:\/\/)(exey|ezlinks|techmody|ouo|ex-e|saly|cuty|evoload|oke|letsupload|eio|oii|exe)(\.io)(\/.*)/
...
// @include /^(https?:\/\/)(cryptoad|wikile|uploadev|mega4upr|cshort|payskip|homeairquality|shortearn|sl.btc25|earnsfly)(\.org)(\/.*)/
...
// @include /^(https?:\/\/)(noweconomy|deportealdia|adshort|ay|pngit|pndx)(\.live)(\/.*)/
...
// @include /^(https?:\/\/)(faucetcrypto|bildirim)(\.eu)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?(i8l|clk|pi-l|bcvc|modli)(\.ink)(\/.*)/
...
// @include /^(https?:\/\/)(mhma12|surflink|techtrim)(\.tech)(\/.*)/
...
// @include /^(https?:\/\/)(adshort|1bit|2the|careerhunter|galaxy-link)(\.space)(\/.*)/
// @include /^(https?:\/\/)(makeeasybtc|softindex|techus)(\.website)(\/.*)/
// @include /^(https?:\/\/)(linka|xtrabits|skipads)(\.click)(\/.*)/
// @include /^(https?:\/\/)(.+)?(shortlinks|easysl|adlink|adzilla|urlcash)(\.click)(\/.*)/
...
// @include /^(https?:\/\/)(claim|chuksblog|pricenews|url.getbits)(\.fun)(\/.*)/
...
(function() {
    ...
    BloggerPemula('sport4you.net|nadersoft7.com|manga2day.com|pickhopes.com|gam3ah.com|cars-1year.xyz|m4cut.com|soft3arbi.com', 'link', '', false);
    ...
    BloggerPemula('linksfire.co', 'url,api', '', false);
    ...
    BloggerPemula('ffworld.xyz|thebookaholics.in', 'link', 'https://go.linkbnao.com/', false);
    BloggerPemula('tecnicalboy.com', 'link', 'https://thebookaholics.in/safe.php?link=', false);
    ...
    case 'terafly.me': if (h.searchParams.has('url') && h.href.includes('adnews.me')) {return h.searchParams.getAll('url').filter(u => /http(s|):\/\/adnews.me/.test(u))[0];} break;
    case 'clicksfly.com': case 'shrinkearn.com': case 'clk.sh': case 'cuty.io': var cf = h.searchParams.has('api') && h.searchParams.has('url'); if ( h.searchParams.has('url') && h.href.includes('bloogerspoot.') ) {window.location.assign('https://softindex.website'+ h.searchParams.get('url').substring(22));} else if (h.searchParams.has('api') && h.searchParams.has('url') && h.href.includes('futureshor.')) {return 'https://' + h.searchParams.get('url');} else if (cf && h.href.includes('3shorturl.gq')) {return h.searchParams.getAll('url').filter(u => /http(s|):\/\/3shorturl.gq/.test(u))[0];} else if (cf && h.href.includes('360shortlink.cf')) {return h.searchParams.getAll('url').filter(u => /http(s|):\/\/360shortlink.cf/.test(u))[0];} else if (cf && h.href.includes('earnfacut.xyz')) {return h.searchParams.getAll('url').filter(u => /http(s|):\/\/earnfacut.xyz/.test(u))[0];} else if (cf && h.href.includes('short.skalbayrak.com')) {return h.searchParams.getAll('url').filter(u => /http(s|):\/\/short.skalbayrak.com/.test(u))[0];}else{return h.searchParams.get('url');} break;
    ...
    if(location.href.indexOf('diudemy.com') != -1 || location.href.indexOf('djxmaza.in') != -1 || location.href.indexOf('on-scroll.com') != -1 || location.href.indexOf('blog-everything.com') != -1 || location.href.indexOf('proviralhost.com') != -1 || location.href.indexOf('blogmado.com') != -1 || location.href.indexOf('btcpany.com') != -1) {
    ...
    switch (h.host) {case '': case '': if (h.pathname === '/' && h.searchParams.has('url') && h.searchParams.has('sn')) {
    ...
    case 'acortame.xyz': if (window.location.hash) {location.href =""+(atob(window.location.hash.substr(1)));} break;
    ...
    BypassedByBloggerPemula(/sama-pro.com|mikl4forex.com/, () => waitForElm('a#submitBtn', smpb => redirect(smpb.href, false)));
    ...
    BypassedByBloggerPemula(/kalvidudes.in|techwithsanikant.in/, () => waitForElm('div#getlinkbtn center a', kalv => redirect(kalv.href)));
    ...
    BypassedByBloggerPemula(/rancah.com|menjelajahi.com|shortly.xyz|nyawang.com/, function() {clickIfElementExists('.get-link.btn-lg.btn-success.btn', 5, 'setInterval');});
    ...
    BypassedByBloggerPemula(/dutchycorp.space|dutchycorp.ovh|gtlink.co|beingtek.com|zshort.cc|twitonet.com|mdn.rest|antonimos.de|ctbl.me|oii.io|wordcounter.icu|fc-lc.com|myasietv.cc|zagl.in/, function() {var ticker = setInterval(function(){ try{window.grecaptcha.execute(); clearInterval(ticker);} catch(e) {}},3000);});
