...
// @include /^(https?:\/\/)(aylink|linkszia|mynewsmedia|gtlink|linksly|droplink|123link|linksfy|adshorti|hxfile|dosya|veganal|takem|ezimg|eng.ezimg|dausel|modlink|9-animie|veganho|nulledmod|veganac|dealprice|arabplus2|cut-y)(\.co)(\/.*)/
...
// @include /^(https?:\/\/)(newforex|wplink|nbyts|wealthystyle|clicksfly|happy-living|earn-cash|yourtechnology|apks|network-earn|teacherana|earnow|battleroyal)(\.online)(\/.*)/
...
// @include /^(https?:\/\/)(cryptoad|wikile|uploadev|mega4up|doibihar|cshort|payskip|homeairquality|shortearn|sl.btc25|earnsfly)(\.org)(\/.*)/
...
// @include /^(https?:\/\/)(zagl|scratch247|siyn|portablesusb|children-learningreading|azmath|mobilereview|inform3tion|mobilism|machicon-akihabara|cooklike|videoclip|bitcrypto|shortlinkto|uptobhai|brbushare|fanclup)(\.info)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?(exe|exee|exep|upfiles|cutty|linkfly)(\.app)(\/.*)/
...
// @include /^(https?:\/\/)(claim|chuksblog|pricenews)(\.fun)(\/.*)/
...
(function() {
    ...
    BypassedByBloggerPemula(/exee.app/, function() {if (elementExists('#before-captcha')) { setTimeout(function() {bp('#before-captcha').submit();}, 2000);}});
    ...
    BypassedByBloggerPemula(/dutchycorp.space|dutchycorp.ovh|gtlink.co|beingtek.com|zshort.cc|twitonet.com|mdn.rest|antonimos.de|ctbl.me|oii.io|wordcounter.icu|fc-lc.com|myasietv.cc/, function() {var ticker = setInterval(function(){ try{window.grecaptcha.execute(); clearInterval(ticker);} catch(e) {}},3000);});
